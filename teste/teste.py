...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def listagemTotal(self):
        ra, ok = QtWidgets.QInputDialog.getText(self, "Listing", "Enter RA:")
        if ok and ra:
            ...
            self.tab_listagem.lineEdit_name.setText(name)
            self.tab_listagem.lineEdit_RA.setText(ra)
            self.tab_listagem.lineEdit_email.setText(email)
            self.tab_listagem.lineEdit_property_id.setText(property_id)
            self.tab_listagem.lineEdit_Idimovel.setText(idImovel)
            self.tab_listagem.label_absent_days.setText(absent_days)
            self.tab_listagem.lineEdit_bloco.setText(bloco)
            self.tab_listagem.lineEdit_idApontamento.setText(idApontamento)
            self.tab_listagem.lineEdit_entrada.setText(entrada)
            self.tab_listagem.lineEdit_saida.setText(saida)
